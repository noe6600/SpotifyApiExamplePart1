...
public class Webservice {
        ...
        spotify.getArtistTopTrack(spotifyId, options, new Callback<Tracks>() {
            ...
            public void success(Tracks tracks, Response response) {
                ...
                for(Track track : tracks.tracks){
                    ...
                    values[i] = setTrackValues(artistId, track.id, track.name, track.album.name, thumbnail, track.preview_url);
                    i++;
                }
    ...
    private static ContentValues setTrackValues(String artistId, String spotifyId, String name, String album, String thumbnail, String previewUrl) {
        ContentValues values = new ContentValues();
